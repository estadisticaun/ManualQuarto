...
3.  A continuación, dale un nombre a tu presentación y especifica el nombre del autor, y no olvides escoger el formato de la presentación (*Reveal JS, Beamer, PowerPoint*) pero no te afanes porque puedes modificarlo más adelante. 
![](Imagenes/02_Presentaciones/01_preliminares.png)

4.  Quedará una presentación así
![](Imagenes/02_Presentaciones/02_Fin_creacion.png)
...
También podemos agregar bloques de código a nuestras presentación 
